...
public class CreatorRepositoryImpl implements ICreatorRepository {
    ...
    public void createTables() throws SQLException {
        connection.createStatement().executeUpdate(
                "CREATE TABLE " +
                        ...
                        "surname VARCHAR(20) NOT NULL, PRIMARY KEY(id)" +
                        ")"
        );
    }
    ...
    public void setConnection(Connection connection) throws SQLException {
        ...
        addCreatorStatement = connection.prepareStatement("INSERT INTO Creator (name, surname) VALUES (?, ?)", Statement.RETURN_GENERATED_KEYS);
    ...
    public int add(Creator creator) {
        ...
        try {
            ...
            ResultSet generatedKeys = addCreatorStatement.getGeneratedKeys();
            if (generatedKeys.next()) {
                creator.setId(generatedKeys.getLong(1));
            }
        } catch (SQLException e) {
            throw new IllegalStateException(e.getMessage() + "\n" + e.getStackTrace().toString());
        }
